...
#include <memory>
#include "../../SortedSyt/BubbleSort.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BubbleSort_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BubbleSort_t qt_meta_stringdata_BubbleSort = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_BubbleSort[] = {
...
Q_CONSTINIT const QMetaObject BubbleSort::staticMetaObject = { {
    ...
    qt_meta_stringdata_BubbleSort.offsetsAndSizes,
    qt_meta_data_BubbleSort,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BubbleSort_t,
        // Q_OBJECT / Q_GADGET
